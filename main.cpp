...
int main(int argc, char** argv)
{
    ...
    parameters.template_size = 200; // 200 
    parameters.gsl_sigma = 1.0f; // for createing gussian response 
    // parameters.hog_orientations = 9;
    // parameters.hog_clip = 0.2f;
    parameters.num_hog_channels_used = 18; // need to som e change in csrtUTILS file in 2 place 
    ...
    //DSST MODULE---------------------------------------------------------------
    parameters.number_of_scales = 33; // 33 this effect on changeing scale of window 
